...
*/
#include "Hospital.h" // incluye todas las etsructuras y sus funciones 
...
int main() { 
    ...
    do {
        ...
        // restriccion para validar la opcion
        ...
        switch (op) {
            case 1:
                do {
                    ...
                    // validacion para las opciones del sub menu 
                    while (scanf("%d", &sub) != 1 || sub < 1 || sub > 7) {
                        printf("Seleccione una opcion valida: ");
                        while (getchar() != '\n');
                    }
                    ...
                    switch (sub) {
                        ...
                        case 2: agregarPaciente(&pacientes, &doctores, &hospitales); break;
                        case 3: agregarDoctor(&doctores, &especialidades, &trabajadores); break;
                        case 4: agregarIntendencia(&intendencias, &trabajadores); break;
                        case 5: agregarEspecialidad(&especialidades, &equipos); break;
                        case 6: agregarEquipo(&equipos); break;
                    }
