...
El archivo selection.h declara la función selectionSort, permitiendo su uso en otros archivos. 
Incluye guardas para evitar duplicaciones. */

#ifndef SELECTION_H
#define SELECTION_H
//Declaración de la función selectionSort
